        ...
        for item in item_list:
            ...
            try:
                ...
                if "markerKey" in item and "ad_business" not in str(item["markerKey"]):
                    ...
                    detail_doc["categories"] = item["searchResultBusiness"]["categories"]
                    ...
                    if detail is not None:
                        ...
                        detail_doc["reviews_detail"] = detail["reviews_detail"]
                        detail_doc["label_list"] = detail["label_list"]
                        # detail_doc["html"] = detail["html"]
                    print(detail_doc)
                    print(3)
                    # MX add
                    with open('/Users/annawang/icloud/Documents/yelp/yelp-master/NY_bar.json', 'a') as f:
                        json.dump(detail_doc, f, ensure_ascii=False, indent=4)
            except Exception:
                logger.error(traceback.format_exc())
        start_number += 30

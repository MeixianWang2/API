...
class YelpSpider:
    ...
    def get_page(self, start_number):
        url = "https://www.yelp.com/search/snippet?find_desc=restaurants&find_loc=New%20York%2C%20NY%2C%20United%20States&start={}&parent_request_id=dfcaae5fb7b44685&request_origin=user" \
            .format(start_number)
        headers_str = b"""
        ...
        try:
            ...
            with open('/Users/annawang/icloud/Documents/yelp/yelp-master/NY_text.json', 'a') as f:
    ...
    def get_detail(self, url_suffix):
        ...
        headers_str = b"""
            ...
            method: GET
            path: /biz/district-social-new-york?hrid=295oISkILBXnFFf_ZVDTQw&osq=restaurants
            scheme: https
        ...
        try:
            response = requests.get(url=url, headers=headers, timeout=10)
            text = response.text
            with open('/Users/annawang/icloud/Documents/yelp/yelp-master/NY_response.json', 'a') as f:
                json.dump(text, f, ensure_ascii=False, indent=4)
            reviews_detail = re.search("\"reviews\":(.*?),\"comment\"", text).groups()[0]
            ...
            detail["reviews_detail"] = reviews_detail
